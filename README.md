# fastfetch-config
TUI tool to manage your fastfetch configuration. Not confirmed to work on all operating systems. Works best on Arch Linux, or Arch Linux based distros, like CachyOS, EndeavourOS, etc. There is (VERY EXPERIMENTAL) support for MacOS, but it is not recommended yet.
